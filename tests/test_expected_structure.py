...
FORBIDDEN = ["docs/legacy", "results/registries", "results/auxiliary/pan_full_eval", "workflows/evaluate/legacy", "environment/snapshots", "environment/common/common", "data/audit", "results/reports/merge_provenance.md"]

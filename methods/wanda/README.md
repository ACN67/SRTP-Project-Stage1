...
The Qwen wrapper should use project split files as calibration text, starting with `data/benchmarks/smoke/humaneval/guide.jsonl`. The first R2 target is intentionally small: Qwen2.5-Coder-1.5B-Instruct, four HumanEval guide samples, unstructured 10% sparsity, batch size 1, and sequence length 512.

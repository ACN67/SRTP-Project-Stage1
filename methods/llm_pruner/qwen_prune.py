...
def main() -> int:
    ...
    if args.save_model:
        ...
        shape_manifest = {
            ...
            "loader": "methods.llm_pruner.qwen_prune.load_llmpruner_qwen_model",
        }

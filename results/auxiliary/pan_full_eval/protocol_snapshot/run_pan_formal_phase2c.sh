...
for rel in \
  ...
  workflows/audit/aggregate_pan_formal_results.py
 do
  cp "$WIN/$rel" "$rel"
...
HE_EVAL=data/benchmarks/auxiliary_full_eval/humaneval/eval.jsonl
MB_EVAL=data/benchmarks/smoke/mbpp_evalplus/eval.jsonl

...
- Splits + leakage audit: done (`reports/stage1/split_leakage_check.json`)
...
- Status table: `results/tables/method_status.csv`

## Formal Rerun (paper-grade comparison)

Do **not** treat 4-task smoke generations as main conclusions. Formal numbers live in:

- Table: [`results/tables/pan_formal_comparison.csv`](../../results/tables/pan_formal_comparison.csv)
- Summary: [`reports/stage1/pan_formal_results.md`](pan_formal_results.md)
- Raw root (WSL): `results/raw/pan_formal_20260724_203248/`

### Protocol

- Model (code): `Qwen/Qwen2.5-Coder-1.5B-Instruct` only; no 7B/13B; 3B not used as main result
- Splits: `data/splits/humaneval_formal/` (guide 32 / eval 164), `mbpp_formal/` (guide 32), plus `mbpp_evalplus/` (378) for evalplus IDs

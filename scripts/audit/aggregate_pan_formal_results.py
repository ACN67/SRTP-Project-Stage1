#!/usr/bin/env python3
"""Aggregate pan formal OPT/Qwen results into results/tables/pan_formal_comparison.csv."""
...
def main() -> int:
    ...
    parser.add_argument("--output", default="results/tables/pan_formal_comparison.csv")
